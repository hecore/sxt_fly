...
import com.orm.sorm.utils.JavaFileUtils;
import com.orm.sorm.utils.StringUtils;
...
//    map max
    ...
    //package po's classObj and TableObj,then reforence.
...
//   mul-level:tree level
            while (tableSet.next()){
                ...
                while (set.next()){
                    ...
                    System.out.println(set.getString("COLUMN_NAME")+"--"+ci+"--"+ti.getColumns());
