...
import com.orm.sorm.bean.ColumnInfo;
import com.orm.sorm.bean.JavaFieldGetSet;
import com.orm.sorm.bean.TableInfo;
import com.orm.sorm.core.DBManager;
import com.orm.sorm.core.MySqlTypeConvertor;
import com.orm.sorm.core.TableContext;
import com.orm.sorm.core.TypeConvertor;
...
public class JavaFileUtils {
     ...
     * @param column 字段信息
     * @param convertor 类型转化器(interface)    when we use it,we set convertor impl
...
//		JavaFieldGetSet f = createFieldGetSetSRC(ci,new MySqlTypeConvertor());//its a object
